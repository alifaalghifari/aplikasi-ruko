...
DROP TABLE IF EXISTS `alat_pertanian`;
...
LOCK TABLES `alat_pertanian` WRITE;
/*!40000 ALTER TABLE `alat_pertanian` DISABLE KEYS */;
/*!40000 ALTER TABLE `alat_pertanian` ENABLE KEYS */;
UNLOCK TABLES;
